...
background = transform.scale(image.load("depositphotos_646911734-stock-illustration-space-background-alien-planet-landscape.jpg"),
...
for i in range(1, 10):
    monster = Enemy("2828492.png", randint(80, win_width - 80), 0, 2)
